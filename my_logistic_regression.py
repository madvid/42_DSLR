...
class MyLogisticRegression():
	...
	def _fit_(self, x:np.ndarray, y:np.ndarray, n_cycle:int=None):
		"""
		...Docstring...
		"""
		if n_cycle is None:
...
class MyLogisticRegressionWithHistory(MyLogisticRegression):
	...
	def _stochastic_fit_(self, x:np.ndarray, y:np.ndarray, start:int, n_cycle:int=None):
		"""
		...Docstring...
		"""
		m = x.shape[0]
	...
	def _stochastic_fit_w_momentum_(self, x:np.ndarray, y:np.ndarray, start:int, n_cycle:int=None):
		"""
		...Docstring...
		"""
		m = x.shape[0]
	...
	def _minibatch_fit_history_(self, mini_batches:list, n_cycle:int=None):
		"""
		...Docstring...
		"""
		for _ in  range(self.steps):
